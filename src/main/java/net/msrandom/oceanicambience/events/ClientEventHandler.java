...
import net.msrandom.oceanicambience.client.render.SlenderSunfishRenderer;
import net.msrandom.oceanicambience.client.render.SwellSharkRenderer;
...
public class ClientEventHandler {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(OAEntities.SLENDER_SUNFISH, SlenderSunfishRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(OAEntities.SWELL_SHARK, SwellSharkRenderer::new);
    }
}
